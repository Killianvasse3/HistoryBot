...
def load_lottiefile(filepath: str):
    with open(filepath, "r") as f:
        return json.load(f)
st_lottie(load_lottiefile("images/Map.json"), speed=1, reverse=False, loop=True, quality="high", height=300)
...
def send_message(user_input):
    ...
    with st.spinner('Generating response...'):
        llm_stream = chat(user_input, model='Geographie', history=st.session_state.messages)
